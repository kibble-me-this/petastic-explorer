...
export default function PostItem({ post, index }) {
  ...
  // Use the sample blog entry data
  const { _id, title, description, hero_image_url, published_at, author, totalViews, totalShares, totalComments } = post;
  ...
  return (
    <Card>
      <Box sx={{ position: 'relative' }}>
        ...
        <Image alt={title} src={hero_image_url} ratio="4/3" />
      </Box>
