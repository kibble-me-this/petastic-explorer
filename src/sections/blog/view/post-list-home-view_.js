...
// api
import { useGetPosts, useSearchPosts } from 'src/api/blog_';
...
export default function PostListHomeView() {
  ...
  console.log("PostListHomeView posts: ", posts);
  console.log("PostListHomeView postsLoading: ", postsLoading);
  ...
  console.log("PostListHomeView dataFiltered: ", dataFiltered);
