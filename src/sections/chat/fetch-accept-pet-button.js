    ...
    if (!buttonClicked) {
      ...
      try {
        ...
        if (magicIsLoggedIn) {
          ...
          <p>It's free for you, and you will receive 100 Kibble Cash ($100 USD) that you can use towards your purchases. All you have to do is opt in below. </p> html login button`;
          const messageArray2 = [
            {
              role: 'user',
